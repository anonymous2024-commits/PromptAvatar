...
from DataSet_Step4_UV_Texture.utils import read_img, img2mask
from DataSet_Step4_UV_Texture.tex.tex_func import remap_tex_from_input2D, fill_facial_region, blend_with_template
from DataSet_Step4_UV_Texture.tex.poisson_blend import poisson_blend, get_laplacian_matrices
...
class Tex_API:
    ...
    def from_one(self, img, seg_mask, projXY, norm):
        '''
