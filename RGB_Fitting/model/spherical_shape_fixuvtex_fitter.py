...
from RGB_Fitting.utils.preprocess_utils import estimate_norm_torch
from RGB_Fitting.utils.data_utils import tensor2np, draw_mask, draw_landmarks, img3channel
...
class Fitter:
    ...
    def __init__(self,
        ...
        self.pred_uv_map = uv_map_lr
        self.pred_uv_map_hr = uv_map_hr
        # init coeffs
    ...
    def forward(self):
        ...
        # render full head
        vertex_uv_coord = self.facemodel.vtx_vt.unsqueeze(0).repeat(self.pred_vertex.size()[0], 1, 1)
