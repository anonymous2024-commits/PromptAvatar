...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir',
                        type=str,
                        default='../examples/fitting_examples/inputs/processed_data',
                        help='directory of input data')
    parser.add_argument('--output_dir',
                        type=str,
                        default='../examples/fitting_examples/outputs',
                        help='directory of outputs')
    parser.add_argument('--checkpoints_dir', type=str, default='../checkpoints', help='pretrained models.')
    parser.add_argument('--topo_dir', type=str, default='../assets_topo', help='assets of topo.')
